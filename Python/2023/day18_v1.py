# Day 18, part 1 of Advent of Code 2023

#data_file = open('./Data/2023/day18_test1.txt', 'r')

data_file = open('./Data/2023/day18.txt', 'r')
...
#file = open('./Data/2023/day18_test1_result.txt','w')
file = open('./Data/2023/day18_result.txt','w')
file.write('\n'.join(''.join(dig for dig in row) for row in lagoon))
file.close()